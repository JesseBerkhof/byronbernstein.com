...
{{--            </div>--}}
            <div class="flex mt-24">
                <div class="w-full text-center">
                    ...
                    <h2 class="text-4xl text-orange-900">Stop the spread by dabbing your cough or sneeze.</h2>
                    <h2 class="text-2xl text-orange-900">Use <span class="font-bold">#CoronaDab</span> on socials.</h2>
                </div>
            </div>
